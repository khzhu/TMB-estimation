...
calculate_tmb <- function(maf_file, out_tsv, tumor_coverage, alt_count, tumor_vaf, callable=1408279) {
  # read input files
...
# Estimate TMB
calculate_tmb(opt$maf, opt$out, opt$depth, opt$count, opt$vaf, opt$callable)